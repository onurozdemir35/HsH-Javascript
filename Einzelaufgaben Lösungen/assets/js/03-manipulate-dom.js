...
paragraph.textContent = "Hier ist ein bisschen Text zum lesen.";
document.querySelector("#fetch-form").appendChild(paragraph);
...
document.querySelector("#fetch-form p").remove();
